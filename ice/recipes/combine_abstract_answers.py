...
Title A1: Interleukin 13, an interleukin 4-like cytokine that acts on monocytes and B cells, but not on T cells.
...
Title A2: Title A2: Interleukin 13, an interleukin 4-like cytokine that acts on monocytes and B cells, but not on T cells
...
Title A3: Interleukin 13 is a B cell stimulating factor
...
Title A4: Interleukin-13 is a new human lymphokine regulating inflammatory and immune responses
...
async def combine_abstract_answers(
    ...
    return await recipe.agent().complete(
        prompt=prompt, stop="###", max_tokens=remaining_tokens
    )
